...
export const ERROR_HTTP_STATUS: Record<QueueErrorCode, number> = {
  [QUEUE_ERROR_CODES.CONNECTION_INVALID]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.CONNECTION_REQUIRES_NULL_RETRIES]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.CONNECTION_TIMEOUT]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.QUEUE_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [QUEUE_ERROR_CODES.JOB_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [QUEUE_ERROR_CODES.INVALID_JOB_DATA]: HttpStatus.BAD_REQUEST,
  [QUEUE_ERROR_CODES.INVALID_REPEAT_OPTIONS]: HttpStatus.BAD_REQUEST,
  [QUEUE_ERROR_CODES.DUPLICATE_PROCESSOR]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.FLOW_DISABLED]: HttpStatus.SERVICE_UNAVAILABLE,
  [QUEUE_ERROR_CODES.METRICS_DISABLED]: HttpStatus.SERVICE_UNAVAILABLE,
  [QUEUE_ERROR_CODES.SHUTDOWN_TIMEOUT_EXCEEDED]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.BULK_ENQUEUE_FAILED]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.WORKER_REGISTRATION_FAILED]: HttpStatus.INTERNAL_SERVER_ERROR,
  [QUEUE_ERROR_CODES.INVALID_OPTIONS]: HttpStatus.INTERNAL_SERVER_ERROR,
}
